...
function Menu() {
	...
	this.normal_text_text = "I want to dance around Undyne.";
	this.hard_text_text = "I want to spar on even terms.";
	this.genocide_text_text = "I want to fight the True Hero.";
